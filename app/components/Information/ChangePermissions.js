...
const ChangePermissions = () => {
  return (
    <div>
      ...
      <p>To change only active permission select youraccount@active for your Ironman identity</p>
      <p>To change any permission select youraccount@owner for your Ironman identity</p>
      <p>If you change your active permission you have to update your ironman identity to use this new key pair</p>
      <p>
