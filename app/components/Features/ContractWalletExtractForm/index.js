...
const ContractWalletExtractForm = props => {
  return (
    <Tool>
      <ToolSection lg={8}>
        <ToolBody color="warning" icon={Redo} header="Contract Wallet Extract" subheader="">
          <FormObject {...props} />
        </ToolBody>
      </ToolSection>
      <ToolSection lg={4}>
...
export default enhance(ContractWalletExtractForm);
